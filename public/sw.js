 ...
 */
const CACHE_VERSION = 'axhub-v222';
 ...
 */
const SWR = /\/(finder|compare|install|install-cost|care|quiz|test|place|as|poster)-app\.html$|\/(search-(index|detail)|size-reps|plan-library|finder-extra|finder-core|install-cost|svc-centers)\.json$|\/(share-kit|prod-symbols|back-kit)\.js$/;
