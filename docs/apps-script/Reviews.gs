...
/* ── 대상 매장 44곳 ───────────────────────────────────────────────
 * 전체 65곳에서 **캠퍼스·사업장 안 모바일 전용점 21곳을 뺐다.**
 * 실측(2026-08-31): 그 21곳은 블로그·카페 **전부 0건**이다 — 공개 후기가 구조적으로
 * 없다. 매일 두드려도 0 이라 호출만 낭비고, 무엇보다 대시보드에 「0건」이 21줄
 * 늘어서면 진짜 신호가 묻힌다. */
var STORES = [
  ['ZN01', '스타필드수원'], ['Z279', '오산'], ['Z047', '수지'], ['Z150', '강릉옥천'],
  ['Z205', '단구'], ['Z206', '석사'], ['Z227', '속초'], ['Z243', '평택'],
  ['Z324', '분당'], ['Z343', '북수원'], ['Z378', '광주'], ['Z403', '안성'],
  ['Z404', '평택고덕'], ['Z405', '이천증포'], ['Z407', '평촌'], ['Z409', '용인구성'],
  ['Z410', '서수원'], ['Z411', '영통'], ['Z413', '광명소하'], ['Z414', '성남'],
  ['Z415', 'AK분당'], ['Z416', '원주'], ['Z417', '춘천'], ['Z418', '평택세교'],
  ['Z420', '권선'], ['Z421', '안양본'], ['Z422', '수원'], ['Z423', '동탄'],
  ['Z424', '강릉'], ['Z425', '단계'], ['Z426', '하남미사'], ['Z427', '용인기흥'],
  ['Z428', '롯데평촌'], ['Z429', '롯데수원'], ['Z430', '현대판교'], ['Z431', '신세계사우스시티'],
  ['Z432', 'AK수원'], ['Z433', 'AK평택'], ['Z434', 'AK원주'], ['Z435', '신세계하남'],
  ['Z436', '갤러리아광교'], ['Z437', '롯데동탄'], ['Z438', '타임빌라스수원'], ['Z439', '이마트안양']
];
